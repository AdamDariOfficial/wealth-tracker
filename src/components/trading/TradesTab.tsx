      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Per-trade execution log. Individual entries — aggregates roll up to weekly reviews.
          </p>
        </div>
        ...
        {[
          {
            ...
            c: stats.totalPnl >= 0 ? "text-success" : "text-destructive",
          },
      ...
      <div className="glass rounded-2xl overflow-hidden">
        <table className="w-full text-sm">
          <thead className="text-[11px] uppercase tracking-wider text-muted-foreground border-y border-border/40">
            <tr>
              {["Date", "Asset", "Side", "Entry", "SL", "TP", "P&L", "R:R", "Setup", ""].map(
                (h) => (
              ...
              <tr key={t.id} className="border-b border-border/30 hover:bg-muted/20">
                ...
                <td
                  className={cn(
                    ...
                    Number(t.pnl) >= 0 ? "text-success" : "text-destructive",
                  )}
                >
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button className="bg-cyan text-background hover:bg-cyan/90" onClick={save}>
              Save
            </Button>
          </>
        }
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              className="mt-1 w-full h-9 rounded-md bg-background border border-input px-2 text-sm"
